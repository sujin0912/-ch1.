...
export class SubscriptionsService {
    ...
    async subscribe(
        ...
        const category = await this.subscriptionsRepository. findActiveCategory(categoryId);
        ...
        const existingSubscription = await this.subscriptionsRepository.findSubscription(
            userId, categoryId,
        );
